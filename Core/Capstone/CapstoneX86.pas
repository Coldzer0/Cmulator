...
type
  ...
  x86_op_type = (
    ...
    X86_OP_MEM_, // = CS_OP_MEM (Memory operand).
  ...
  x86_prefix = (
    X86_PREFIX_LOCK    =   $f0,  // lock (cs_x86.prefix[0]
    X86_PREFIX_REP    =   $f3,  // rep (cs_x86.prefix[0]
    X86_PREFIX_REPNE  =   $f2,  // repne (cs_x86.prefix[0]

    X86_PREFIX_CS    =   $2e,  // segment override CS (cs_x86.prefix[1]
    X86_PREFIX_SS    =   $36,  // segment override SS (cs_x86.prefix[1]
    X86_PREFIX_DS    =   $3e,  // segment override DS (cs_x86.prefix[1]
    X86_PREFIX_ES    =   $26,  // segment override ES (cs_x86.prefix[1]
    X86_PREFIX_FS    =   $64,  // segment override FS (cs_x86.prefix[1]
    X86_PREFIX_GS    =   $65,  // segment override GS (cs_x86.prefix[1]

    X86_PREFIX_OPSIZE  =  $66,  // operand-size override (cs_x86.prefix[2]
    X86_PREFIX_ADDRSIZE  =  $67  // address-size override (cs_x86.prefix[3]
  );
  ...
  cs_x86_op = record
    op: __cs_x86_op;
    size: Byte;
    avx_bcast: Integer;          // x86_avx_bcast
  ...
  cs_x86 = record
    ...
    sib: Byte;
    disp: Integer;
    sib_index: Integer;     // x86_reg
    sib_scale: Integer;     // int8_t
    sib_base: Integer;      // x86_reg
    sse_cc: Integer;        // x86_sse_cc
    avx_cc: Integer;        // x86_avx_cc
    avx_sae: LongBool;
    avx_rm: Integer;        // x86_avx_rm
    op_count: Byte;
