...
type
  ...
  ppc_bc = (
    PPC_BC_INVALID  = 0,
    PPC_BC_LT       = (0 shl 5) or 12,
    PPC_BC_LE       = (1 shl 5) or  4,
    PPC_BC_EQ       = (2 shl 5) or 12,
    PPC_BC_GE       = (0 shl 5) or  4,
    PPC_BC_GT       = (1 shl 5) or 12,
    PPC_BC_NE       = (2 shl 5) or  4,
    PPC_BC_UN       = (3 shl 5) or 12,
    PPC_BC_NU       = (3 shl 5) or  4,

    // extra conditions
    PPC_BC_SO = (4 shl 5) or 12,	// summary overflow
    PPC_BC_NS = (4 shl 5) or 4	// not summary overflow
  );
  ...
  ppc_op_type = (
    ...
    PPC_OP_MEM_, // = CS_OP_MEM (Memory operand).
    PPC_OP_CRX_ = 64	// Condition Register field
  );
