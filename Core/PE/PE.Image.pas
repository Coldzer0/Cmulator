...
type
  ...
  public
    ...
    function SaveToStream(AStream: TStream; SavingModifiedImage : Boolean = False): boolean;
...
function TPEImage.SaveToStream(AStream: TStream; SavingModifiedImage : Boolean = False): boolean;
begin
  Result := PE.Image.Saving.SaveImageToStream(self, AStream, SavingModifiedImage);
end;
