...
type
  TPseElfLoader = class(TPseImgLoader)
  private
...
procedure TPseElfLoader.Load(AMem: TPseVirtMem);
var
  i: integer;
begin
...
procedure TPseElfLoader.LoadSection(AMem: TPseVirtMem; ASection: TPseSection);
var
  seg: TPseMemSegment;
  flags: TPseMemFlags;
  ms: TMemoryStream;
